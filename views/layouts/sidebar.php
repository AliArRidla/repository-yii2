 <div class="main-sidebar">
     <aside id="sidebar-wrapper">
         <div class="sidebar-brand">
             <a href="/mahasiswa/index">Magang</a>
         </div>
         ...
         <ul class="sidebar-menu">
             ...
             <li class="nav-item dropdown active">
                 ...
                 <ul class="dropdown-menu">
                     <li><a class="nav-link" href="/mahasiswa/create"><i class="fas fa-plus"></i>Mahasiswa</a></li>
             </li>
             <li class="active"><a class="nav-link" href="/mahasiswa/index"><i class="fas fa-user"></i>Mahasiswa</a></li>
         </ul>
         </li>
         ...
         <li><a class="nav-link" href="credits.html"><i class="fas fa-pencil-ruler"></i> <span>Print</span></a></li>
         </ul>
